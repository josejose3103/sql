...
# ✅ 会社情報（フォントを大きく 12pt）
c.setFont("MSGothic", 12)
c.drawRightString(width - 50, 100, "北海道川上郡弟子屈町朝日2丁目4-30")
c.drawRightString(width - 50, 85, "株式会社 TUB （T9560001004706）")
c.drawRightString(width - 50, 70, "代表取締役 坪井 聡之")  # ✅ 修正

# ✅ 振込口座情報（フォントを大きく 12pt）
c.setFont("MSGothic", 12)
c.drawRightString(width - 50, 50, "下記の口座に入金してください")
c.drawRightString(width - 50, 35, "摩周湖農業協同組合　本所")
c.drawRightString(width - 50, 20, "普通　0022095")
c.drawRightString(width - 50, 5, "株式会社 TUB")
c.drawRightString(width - 50, -10, "代表取締役 坪井 聡之")  # ✅ 追加
