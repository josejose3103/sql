...
c.drawCentredString(width / 2, height - 50, "請求書")  # 中央配置

# ✅ 農家名と日付を中央に配置
c.setFont("MSGothic", 12)
c.drawCentredString(width / 2, height - 80, f"農家名: {farmer_name}")
c.drawCentredString(width / 2, height - 100, f"処理日: {today}")

# ✅ ヘッダー（番号と病名の間隔を広げる）
c.drawString(50, height - 130, "番号")
c.drawString(150, height - 130, "病名")  # 100 → 150px で広げた
c.drawString(350, height - 130, "金額（税込）")

# 横線
c.line(50, height - 135, 500, height - 135)
